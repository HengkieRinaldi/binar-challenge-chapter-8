...
socket.on("player-1-wins", ({myChoice, enemyChoice}) => {
    if(playerId === 1){
        let message = "kamu memilih " + myChoice + " dan musuh memilih " + enemyChoice + " . Hasinya Kamu MENANG...";
        setWinningMessage(message);
        myScorePoints++;
    }else{
        let message = "kamu memilih " + myChoice + " dan musuh memilih " + enemyChoice + " . Hasilnya Kamu KALAH";
        setWinningMessage(message);
        enemyScorePoints++;
    }
...
socket.on("player-2-wins", ({myChoice, enemyChoice}) => {
    if(playerId === 2){
        let message = "Kamu Memilih " + myChoice + " dan musuh memilih " + enemyChoice + " . Hasilnya Kamu MENANG...";
        setWinningMessage(message);
        myScorePoints++;
    }else{
        let message = "kamu memilih " + myChoice + " dan musuh memilih " + enemyChoice + " . Hasilnya Kamu KALAH...";
...
function setPlayerTag(playerId){
    if(playerId === 1){
        playerOneTag.innerText = "Kamu (Player 1)";
        playerTwoTag.innerText = "Musuh (Player 2)";
    }else{
        playerOneTag.innerText = "Musuh (Player 2)";
        playerTwoTag.innerText = "Kamu (Player 1)";
    }
}
...
function setWaitMessage(display){
    if(display){
        let p = document.createElement("p");
        p.innerText = "Menunggu Pemain Lain Untuk Bergabung Permainan";
